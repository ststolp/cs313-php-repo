...
( 
    ...
    , 93
    , 28
    , 'He that keepeth his commandments receiveth truth and light, until he is glorified
...
( 
    ...
    can never be darkened; yea, and also a life which is endless, that there can be no more death.'
);